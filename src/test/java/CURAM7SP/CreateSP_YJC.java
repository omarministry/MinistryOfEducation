...
public class CreateSP_YJC extends testbaseforproject{
	LoginElements login;
	...
	public void createPlanItem() throws InterruptedException, AWTException {
		...
		try {
			...
			logger = report.startTest("Create Youth Job Connection service plan");
			...
			createSP.createNewServicePlan("Youth Job Connection", "EO - Action Center", "3898A - TDSB - Next Steps (Meadowvale) -  6435 Erin Mills Parkway, C-02 and C-03, Mississauga, ON L5N 4H4", "Yes");

			//Switch driver to SP_YJCElements
			yjce = new SP_YJCElements(driver);
			...
			yjce.InternationallyTrainedProfessional.sendKeys("Yes");
			yjce.LabourForce.sendKeys("Employed Full Time");
			yjce.CredentialsNotRecognized.sendKeys("College Diploma");
			...
			yjce.TimeOutOfTraining.sendKeys("3 to 6 Months");
