...
public class CAMS6_CreatePDC extends testbaseforproject{
	...
	public void globalLoookupByCaseID(String sheetName) throws InterruptedException, IOException {
		...
		String CaseID = Integer.toString(data.readExcel(filePath, "CaseID_CAMS6.xlsx", sheetName));
...
//		logger.log(LogStatus.PASS, "Site Map is opened");
		...
		//Click on select all Evidence check box
		pdc.PendingApprovalEvidenceCheckbox.click();
		System.out.println("All Evidence check box is clicked");
		logger.log(LogStatus.PASS, "All Evidence check box is clicked");
	...
	public void reloginAsManager(CAMS6_LoginElements login, String caseName) throws InterruptedException {
		//get the url
		String url = config.getProperty("url");
		getUrl(url);
		
		String username = config.getProperty("userCAMPS6Manager");
		String password = config.getProperty("pwdCAMPS6Manager");
		String usernameRL = config.getProperty("userCAMPS6RegionalLead");
		String passwordRL = config.getProperty("pwdCAMPS6RegionalLead");
	...
	public void reloginAsCaseWorker(CAMS6_LoginElements login) throws InterruptedException {
		//get the url
		String url = config.getProperty("url");
		getUrl(url);
	...
	public boolean checkEFT(CAMS6_RegisterPersonElements rpe) {
		boolean EFT = false;
	...
	public void addMonitors() throws InterruptedException {
		//Go to Monitors tab
		driver.switchTo().window(driver.getWindowHandle());
...
//		verifyErrorsNotPresentWithOutPassReport();
		...
		driver.switchTo().frame(2);
		Thread.sleep(1000);
		pdc.MonitorRefreshButton.click();
