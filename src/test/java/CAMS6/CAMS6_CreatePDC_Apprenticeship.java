...
public class CAMS6_CreatePDC_Apprenticeship extends testbaseforproject{
	...
	public void createPDC() throws InterruptedException, AWTException {
		...
		AssertTextPresentmethodWithExtendPassFail(homeTxt, "Apprenticeship Program Home:");
		System.out.println("Apprenticeship Program home is opened");
		logger.log(LogStatus.PASS, "Apprenticeship Program home is opened");
		
		//Get Apprenticeship Case Reference
		String ApprCaseRef = pdc.PDCCaseReference.getText().trim();
		System.out.println("APPR case Ref: " + ApprCaseRef);
		
		//Write the APPR Case ID into file
		data.writeExcel(filePath, "CaseID_CAMS6.xlsx", "PDC_APPRCaseID", Integer.parseInt(ApprCaseRef));
		System.out.println("APPR Case Reference ID is written to the file");
		...
		createPDC.addMultiYearForecasting("Apprenticeship");
		...
		//Add a Supervisor
		createPDC.addSupervisor("Apprenticeship");
