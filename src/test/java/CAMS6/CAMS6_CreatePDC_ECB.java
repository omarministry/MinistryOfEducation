...
public class CAMS6_CreatePDC_ECB extends testbaseforproject{
	...
	public void createPDC() throws InterruptedException, AWTException {
		...
		System.out.println("ECB case Ref: " + ECBCaseRef);
		
		//Write the ECB Case ID into file
		data.writeExcel(filePath, "CaseID_CAMS6.xlsx", "PDC_ECBCaseID", Integer.parseInt(ECBCaseRef));
